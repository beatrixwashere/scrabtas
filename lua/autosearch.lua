--- autosearch v.02.00 --- by queenbea ---
...
-- 4) hold right and advance four frames
-- 5) hold nothing and advance four frames
-- 6) hold right and advance two frames
-- 7) insert the results into ram watch
...
function onStartup()
    -- setup variables
    print("-- autosearch v.02.00 -- by queenbea --")
